package com.sample.sinchdemotelecom.video;
...
public class CallerVideoScreenActivity extends BaseActivity {

    static final String TAG = CallerVideoScreenActivity.class.getSimpleName();
    ...
    private class UpdateCallDurationTask extends TimerTask {
        ...
        @Override
        public void run() {
            CallerVideoScreenActivity.this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    updateCallDuration();
                }
    ...
    private class SinchCallListener implements VideoCallListener {
        ...
        public void onCallEnded(Call call) {
            ...
            Toast.makeText(CallerVideoScreenActivity.this, endMsg, Toast.LENGTH_LONG).show();
